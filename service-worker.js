...
const CACHE_VERSION = '2.2.0-20260803-1919';
...
const APP_SHELL = [
  ...
  './css/phase27-alert-atmosphere.css',
  './css/phase28-air-attack-evasion.css',
  ...
  './css/phase34-damage-visual-states.css',
  './css/phase35-depth-stealth-realism.css',
  './css/phase36-cinematic-interface.css',
  './css/phase37-immersive-audio.css',
  ...
  './css/phase48-captain-order-execution.css',
  './css/phase49-captain-command-chain.css',
  './css/phase50-captain-combat-cycle.css',
  './css/phase51-captain-command-room.css',
  './css/phase52-captain-delegation-advisor.css',
  './css/phase53-crew-progression-impact.css',
  './css/phase54-career-retention.css',
  './css/product-polish.css',
  './css/tutorial-station-focus.css',
  './css/phase56-combat-feedback.css',
  './js/app.js',
  './js/build.js',
  './js/state.js',
  './js/save.js',
  ...
  './js/systems/alertAtmosphere.js',
  './js/systems/airAttackEvasion.js',
  ...
  './js/systems/submarineDamageVisuals.js',
  './js/systems/depthStealthRealism.js',
  './js/systems/cinematicInterface.js',
  './js/systems/immersiveAudioDirector.js',
  './js/systems/cinematicBriefing.js',
  './js/systems/livingCrewRoles.js',
  ...
  './js/systems/captainOrderExecution.js',
  './js/systems/captainCommandChain.js',
  './js/systems/captainCombatCycle.js',
  './js/systems/captainCommandRoom.js',
  './js/systems/captainDelegationAdvisor.js',
  './js/systems/captainCrewProgressionImpact.js',
  './js/systems/captainCareerRetention.js',
