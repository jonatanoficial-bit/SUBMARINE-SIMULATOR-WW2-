...
ok('build version alpha46', build.get('version') == 'v2.0.0-alpha.46')
ok('build phase 31', build.get('phase') == '31')
ok('save schema 25', build.get('saveSchemaVersion') == 25)
ok('package version alpha46', pkg.get('version') == '2.0.0-alpha.46')
ok('manifest version alpha46', manifest.get('version') == '2.0.0-alpha.46')
...
ok('service worker cache bumped', '2.0.0-alpha.46' in sw)
