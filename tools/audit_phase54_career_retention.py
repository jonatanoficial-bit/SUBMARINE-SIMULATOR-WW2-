...
record('Build version is stable 2.0.0', build.get('version') == '2.0.0' and pkg.get('version') == '2.0.0' and manifest.get('version') == '2.0.0')
record('Build history is phase 54 with commercial identifier', build.get('phase') == '54' and build.get('buildId', '').startswith('SCWW2-2.0.0-'))
...
record('Service worker caches phase 54 files', 'captainCareerRetention.js' in sw and 'phase54-career-retention.css' in sw and "2.0.0" in sw)
