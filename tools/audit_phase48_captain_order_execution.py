...
record('Build version is alpha.63', build.get('version') == 'v2.0.0-alpha.63' and pkg.get('version') == '2.0.0-alpha.63' and manifest.get('version') == '2.0.0-alpha.63')
record('Phase metadata is 48', build.get('phase') == '48' and 'PHASE48_CAPTAIN_ORDER_EXECUTION' in system)
